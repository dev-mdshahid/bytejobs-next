...
const Button = ({
  ...
  // Styles
  const primaryStyle =
    "bg-primary h-fit border border-primary text-white text-md font-semibold px-4 py-1.5 rounded shadow-lg shadow-blue-200 hover:shadow-blue-300 hover:scale-105 active:scale-100 transition " +
    className;
